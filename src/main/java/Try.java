...
public interface Try<T> {
    /**
     * Executes the given operation and returns the result wrapped in a monada.Success or monada.Failure
     */
    ...
    /**
     * Returns the resulting value if this is a monada.Success, otherwise throws the original exception
     */
    T get() throws Throwable;

    /**
     * Returns the resulting value if this is a monada.Success,
    ...
    /**
     * Converts this to a non-empty Optional that wraps the resulting value if this is monada.Success,
     * otherwise returns an empty Optional
     */
    Optional<T> toOptional();

    /**
     * Returns the given default value if this is a monada.Failure,
     * otherwise returns the resulting value
     */
    T getOrElse(T defaultValue);

    /**
     * Returns the resulting value if it is a monada.Success,
    ...
    /**
     * Applies the given action to the resulting value if it is a monada.Success, otherwise does nothing
     *
     * @return the current monada.Try object
     * @throws E if the action throws an exception
     */
    <E extends Throwable> Try<T> onSuccess(ThrowableConsumer<T, E> action) throws E;

    /**
     * Applies the given action to the exception if it is a monada.Failure, otherwise does nothing
     *
     * @return the current monada.Try object
     * @throws E if the action throws an exception
     */
    ...
    /**
     * Converts this monada.Success into a monada.Failure (which holds NoSuchElementException)
     * if it is a monada.Success and the predicate doesn't match for the value,
     * otherwise returns this monada.Try (monada.Success or monada.Failure)
     */
